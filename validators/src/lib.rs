...
```rust
# #[cfg(all(feature = "derive", feature = "base32"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "base32_decoded"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "base64"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "base64_decoded"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "base64_url"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "base64_url_decoded"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "bit"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "boolean"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "byte"))]
# {
use validators::prelude::*;
...
* Traits: `ValidateString`, `ValidateUnsignedInteger`
* By default, the range is unlimited and `ignore_case = true`

#### domain

```rust
# #[cfg(all(feature = "derive", feature = "domain"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "email"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "http_url"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "http_ftp_url"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "ip"))]
# {
use std::net::IpAddr;
...
```rust
# #[cfg(all(feature = "derive", feature = "ipv4"))]
# {
...
```rust
# #[cfg(all(feature = "derive", feature = "ipv6"))]
# {
...
```rust
# #[cfg(all(feature = "derive", feature = "length"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "line"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "mac_address"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "number"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "phone"))]
# {
...
```rust
# #[cfg(all(feature = "derive", feature = "semver"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "semver_req"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "signed_integer"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "text"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "unsigned_integer"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "url"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "uuid"))]
# {
use validators::prelude::*;
...
```rust
# #[cfg(all(feature = "derive", feature = "number", feature = "rocket"))]
# {
...
pub mod prelude {
    ...
    pub mod validators_prelude {
        pub use alloc::{borrow::Cow, format, string::String, vec::Vec};

        #[cfg(feature = "byte-unit")]
        pub use crate::byte_unit;
        #[cfg(feature = "data-encoding")]
