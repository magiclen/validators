                ...
                match port {
                    ...
                    ValidatorOption::NotAllow => {
                        quote! {
                            ...
                            pub fn to_uri_authority_string(&self) -> validators_prelude::Cow<str> {
                                match &self.0 {
                                    validators_prelude::IpAddr::V4(ip) => validators_prelude::Cow::from(validators_prelude::format!("{}", ip)),
                                    validators_prelude::IpAddr::V6(ip) => validators_prelude::Cow::from(validators_prelude::format!("[{}]", ip)),
                                }
                            }
                        }
                    }
